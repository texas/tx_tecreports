...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Travel.distination'
        db.delete_column(u'tx_tecreports_travel', 'distination')

        # Adding field 'Travel.destination'
        db.add_column(u'tx_tecreports_travel', 'destination',
                      self.gf('tx_tecreports.fields.MaxCharField')(default='', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Travel.distination'
        db.add_column(u'tx_tecreports_travel', 'distination',
                      self.gf('tx_tecreports.fields.MaxCharField')(default='', max_length=250),
                      keep_default=False)

        # Deleting field 'Travel.destination'
        db.delete_column(u'tx_tecreports_travel', 'destination')
