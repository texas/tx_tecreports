...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.filer_type'
        db.add_column(u'tx_tecreports_report', 'filer_type',
                      self.gf('tx_tecreports.fields.OptionalMaxCharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.filer_type'
        db.delete_column(u'tx_tecreports_report', 'filer_type')
