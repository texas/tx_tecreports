...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.is_being_processed'
        db.add_column(u'tx_tecreports_report', 'is_being_processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.is_being_processed'
        db.delete_column(u'tx_tecreports_report', 'is_being_processed')
